...
var ytokDirtInclude = parsec.Token("include", "DRTV_FIXED")
var ytokPayeeAlias = parsec.Token("alias", "DRTV_PAYEE_ALIAS")
var ytokPayeeUuid = parsec.Token("uuid", "DRTV_PAYEE_UUID")
